...
def main():
    data_set = {
        ...
        6: {"name": "bari", "age": 79, "sex": "female", "ID": 24234},
        7: {"name": "marina", "age": 7, "sex": "tlv"},
        8: {"name": "bar", "age": 28, "ID": 1234455, "sex": "female"},
        9: {"name":2}, # invalid value just for testing
        10: {"name": "bug", "age": -3, "sex": "female"},
        11: {"ID": 3223,"name": "bug1", "age": "h", "sex": "female"},
        12: {"name": "bug2", "age": 2, "se": "k"} # invalid value just for testing
    }
    """
        Debug test if all dict have at least 3 elements (name,sex,age) optimal.
